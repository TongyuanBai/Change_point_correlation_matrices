...
base_path_input_mst <- "E:/Project/distance_matrix/Poly_Hyperbolic"
# Set the base path for reading data files for NNL
base_path_input_nnl <- "E:/Project/distance_matrix/Poly_Hyperbolic_nnl"
# Set the base path for writing error files
base_path_output <- "E:/Project/Result/Poly_Hyperbolic_ori"
