...
base_path_input_mst <- "E:/Project/distance_matrix/Log_Euclidean_Cholesky"
# Set the base path for reading data files for NNL
base_path_input_nnl <- "E:/Project/distance_matrix/Log_Euclidean_Cholesky_nnl"
# Set the base path for writing error files
base_path_output <- "E:/Project/Result/Log_Euclidean_Cholesky_ori"
