...
import numpy as np
import pandas as pd
from scipy.linalg import sqrtm, solve, logm, expm
...
# Compute the Fr\'chet mean of a list of correlation matrices using log-euclidean metric
...
# Calculate the D^2 metric and its variance for a given sample
...
# Compute the Fr\'chet test statistic
...
# Paths, true values, folders, and ranges definitions
data_folder_path = "E:/Project/dataset"
results_folder_path = "E:/Project/Result/Frechet_log_euclidean"

true_values = {"case_0_eigen_0.1_1": 250, 
               "case_0_eigen_1_5": 250, 
               "case_0_eigen_5_10": 250, 
               "case_1_eigen_0.1_1": 250, 
               "case_1_eigen_1_5": 250, 
               "case_1_eigen_5_10": 250, 
               "case_2_eigen_0.1_1": 250, 
               "case_2_eigen_1_5": 250, 
               "case_2_eigen_5_10": 250}
...
ranges = [(0, 500), (0, 500), (0, 500),
          (250, 750), (250, 750), (250, 750),
          (500, 1000), (500, 1000), (500, 1000)]
          
# Ensure folders and ranges match in length
assert len(folders) == len(ranges)

# Process each folder and range
for folder, range_ in zip(folders, ranges):
    ...
    for file in tqdm(file_list, desc=f"Processing files for {folder}"):
        ...
        cp_result = cp_test(correlation_matrices, 0.2)
